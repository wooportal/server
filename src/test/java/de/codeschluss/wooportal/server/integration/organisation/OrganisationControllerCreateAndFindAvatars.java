...
@SpringBootTest
public class OrganisationControllerCreateAndFindAvatars {
  ...
  public void addAndFindAvatarSuperUserOk() throws IOException {
    ...
    ImageEntity avatarInput = newImageEntity(
        avatarReader.getBase64Picture(),
        avatarReader.getMimeType());
...
public void addAndFindAvatarAdminUserOk() throws IOException {
  ...
  public void addNotValidAvatarDenied() throws IOException {
        ...
        ImageEntity avatarInput = newImageEntity(null,
        avatarReader.getMimeType());

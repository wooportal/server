...
@SpringBootTest
public class MarkupControllerReadAllTest {

  @Autowired
  private LabelController controller;

  private FilterSortPaginate params = new FilterSortPaginate("label", 0, 5, "tagId", "asc", null);

  @Test
  public void findAllWithoutPaginationOk() {
    FilterSortPaginate params = new FilterSortPaginate(null, null, null, "tagId", "asc", null);
  ...
  public void findAllWrongParams() {
    FilterSortPaginate params = new FilterSortPaginate("label", 1, 5, "blablabla123", "wrong", null);
